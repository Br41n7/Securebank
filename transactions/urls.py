...
urlpatterns = [
    ...
    path('beneficiaries/add/', views.AddBeneficiaryView.as_view(), name='add_beneficiary'),
    
    # Scheduled transactions
    path('scheduled/', views.ScheduledTransactionListView.as_view(), name='scheduled_transactions'),
    path('scheduled/add/', views.CreateScheduledTransactionView.as_view(), name='create_scheduled_transaction'),
]
...
from .models import Transaction, TransactionLog, Beneficiary, TransactionLimit, ScheduledTransaction


@admin.register(Transaction)
class TransactionAdmin(admin.ModelAdmin):
    list_display = ('reference', 'transaction_type', 'source_account', 'amount', 'currency', 'status', 'created_at')
    ...
    fieldsets = (
        (_('Transaction Info'), {'fields': ('reference', 'transaction_type', 'priority', 'status')}),
        (_('Accounts'), {'fields': ('source_account', 'destination_account')}),
        (_('Amounts'), {'fields': ('amount', 'currency', 'fee', 'tax', 'total_amount')}),
        (_('Recipient'), {'fields': ('recipient_name', 'recipient_account', 'recipient_bank')}),
        ...
        (_('Timestamps'), {'fields': ('created_at', 'processed_at', 'completed_at', 'updated_at')}),
    )
...
class BeneficiaryAdmin(admin.ModelAdmin):
    list_display = ('name', 'account_number', 'bank_name', 'user', 'beneficiary_type', 'is_favorite')
...
class TransactionLimitAdmin(admin.ModelAdmin):
    list_display = ('user', 'tier', 'daily_transfer_limit', 'single_transfer_limit', 'monthly_transfer_limit')
...
class ScheduledTransactionAdmin(admin.ModelAdmin):
    list_display = ('user', 'beneficiary_name', 'amount', 'frequency', 'status', 'next_execution')

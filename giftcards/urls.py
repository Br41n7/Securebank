...
urlpatterns = [
    ...
    path(
        "cards/<uuid:pk>/verify/",
        views.VerifyGiftCardView.as_view(),
        name="verify_giftcard",
    ),
    path(
        "cards/<uuid:pk>/status/",
        views.GiftCardStatusView.as_view(),
    ...
    path(
        "transactions/",
        views.GiftCardTransactionListView.as_view(),
        name="giftcard_transactions",
    ),
    path(
        "transactions/<uuid:pk>/details/",
        views.TransactionDetailsView.as_view(),

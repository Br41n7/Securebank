...
urlpatterns = [
    ...
    path(
        "airtime/providers/",
        views.AirtimeProvidersView.as_view(),
    ...
    path(
        "bills/validate/",
        views.ValidateCustomerView.as_view(),
    ...
    path(
        "school/validate/", views.ValidateSchoolView.as_view(), name="validate_school"
    ),
    path(
        "school/history/",
        views.SchoolFeeHistoryView.as_view(),
        name="school_fee_history",
    ),
    # Saved services
    ...
    path(
        "saved/<int:pk>/remove/",
        views.RemoveSavedServiceView.as_view(),
        name="remove_saved_service",
    ),
    # Service categories
    path(
        "categories/", views.ServiceCategoriesView.as_view(), name="service_categories"
    ),
    path(
        "categories/<int:pk>/providers/",
        views.CategoryProvidersView.as_view(),

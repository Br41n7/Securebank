...
urlpatterns = [
    ...
    path('methods/<uuid:pk>/remove/', views.RemovePaymentMethodView.as_view(), name='remove_payment_method'),
    path('methods/<uuid:pk>/set-default/', views.SetDefaultPaymentMethodView.as_view(), name='set_default_payment_method'),
    ...
    # Notifications
    path('notifications/', views.PaymentNotificationListView.as_view(), name='payment_notifications'),

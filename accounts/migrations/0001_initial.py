    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('account_type', models.CharField(choices=[('SAVINGS', 'Savings Account'), ('CURRENT', 'Current Account'), ('FIXED_DEPOSIT', 'Fixed Deposit'), ('CRYPTO', 'Crypto Wallet'), ('BUSINESS', 'Business Account')], max_length=20, verbose_name='account type')),
                ...
                ('frozen_balance', models.DecimalField(decimal_places=2, default=Decimal('0.00'), max_digits=15, verbose_name='frozen balance')),
                ('currency', models.CharField(default='NGN', max_length=3, verbose_name='currency')),
                ('status', models.CharField(choices=[('ACTIVE', 'Active'), ('FROZEN', 'Frozen'), ('CLOSED', 'Closed'), ('SUSPENDED', 'Suspended')], default='ACTIVE', max_length=20, verbose_name='status')),
                ('is_default', models.BooleanField(default=False, verbose_name='default account')),
                ('daily_limit', models.DecimalField(decimal_places=2, default=Decimal('500000.00'), max_digits=15, verbose_name='daily limit')),
                ('single_transaction_limit', models.DecimalField(decimal_places=2, default=Decimal('100000.00'), max_digits=15, verbose_name='single transaction limit')),
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='created at')),
                ('updated_at', models.DateTimeField(auto_now=True, verbose_name='updated at')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('login_notifications', models.BooleanField(default=True, verbose_name='login notifications')),
                ('transaction_notifications', models.BooleanField(default=True, verbose_name='transaction notifications')),
                ...
                ('require_otp_for_transactions', models.BooleanField(default=True, verbose_name='require OTP for transactions')),
                ('transaction_threshold', models.DecimalField(decimal_places=2, default=Decimal('10000.00'), max_digits=15, verbose_name='transaction threshold')),
                ('auto_logout_time', models.PositiveIntegerField(default=60, verbose_name='auto logout time (minutes)')),
                ('concurrent_sessions', models.BooleanField(default=False, verbose_name='allow concurrent sessions')),
                ('trusted_devices_only', models.BooleanField(default=False, verbose_name='trusted devices only')),
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='created at')),
                ('updated_at', models.DateTimeField(auto_now=True, verbose_name='updated at')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id_type', models.CharField(blank=True, choices=[('NIN', 'National ID'), ('PASSPORT', 'Passport'), ('DRIVERS_LICENSE', "Driver's License"), ('VOTERS_CARD', "Voter's Card")], max_length=20, verbose_name='ID type')),
                ('id_number', models.CharField(blank=True, max_length=50, verbose_name='ID number')),
                ('id_document', models.ImageField(blank=True, null=True, upload_to='kyc_documents/', verbose_name='ID document')),
                ('proof_of_address', models.ImageField(blank=True, null=True, upload_to='address_documents/', verbose_name='proof of address')),
                ('kyc_status', models.CharField(choices=[('PENDING', 'Pending'), ('VERIFIED', 'Verified'), ('REJECTED', 'Rejected'), ('REVIEW', 'Under Review')], default='PENDING', max_length=20, verbose_name='KYC status')),
                ...
                ('currency', models.CharField(default='NGN', max_length=3, verbose_name='preferred currency')),

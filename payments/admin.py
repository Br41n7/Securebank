...
from .models import PaymentMethod, PaymentTransaction, PaystackCustomer, PaystackWebhook, Refund, PaymentNotification


@admin.register(PaymentMethod)
class PaymentMethodAdmin(admin.ModelAdmin):
    list_display = ('user', 'method_type', 'get_display_name', 'is_default', 'status', 'created_at')
...
class PaymentTransactionAdmin(admin.ModelAdmin):
    list_display = ('reference', 'transaction_type', 'user', 'amount', 'currency', 'status', 'created_at')
...
class RefundAdmin(admin.ModelAdmin):
    list_display = ('reference', 'original_transaction', 'user', 'amount', 'status', 'created_at')

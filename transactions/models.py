...
class Transaction(models.Model):
    ...
    recipient_account = models.CharField(_('recipient account'), max_length=50, blank=True)
...
class Beneficiary(models.Model):
    ...
    beneficiary_type = models.CharField(_('beneficiary type'), max_length=10, choices=BENEFICIARY_TYPE_CHOICES)
...
class TransactionLimit(models.Model):
    ...
    tier = models.CharField(_('tier'), max_length=10, choices=TIER_CHOICES, default='BASIC')
    
    # Daily limits
    daily_transfer_limit = models.DecimalField(_('daily transfer limit'), max_digits=15, decimal_places=2, default=Decimal('100000.00'))
    daily_withdrawal_limit = models.DecimalField(_('daily withdrawal limit'), max_digits=15, decimal_places=2, default=Decimal('50000.00'))
    daily_crypto_limit = models.DecimalField(_('daily crypto limit'), max_digits=15, decimal_places=2, default=Decimal('200000.00'))
    
    # Single transaction limits
    single_transfer_limit = models.DecimalField(_('single transfer limit'), max_digits=15, decimal_places=2, default=Decimal('50000.00'))
    single_withdrawal_limit = models.DecimalField(_('single withdrawal limit'), max_digits=15, decimal_places=2, default=Decimal('20000.00'))
    single_crypto_limit = models.DecimalField(_('single crypto limit'), max_digits=15, decimal_places=2, default=Decimal('100000.00'))
    
    # Monthly limits
    monthly_transfer_limit = models.DecimalField(_('monthly transfer limit'), max_digits=15, decimal_places=2, default=Decimal('2000000.00'))
    monthly_withdrawal_limit = models.DecimalField(_('monthly withdrawal limit'), max_digits=15, decimal_places=2, default=Decimal('1000000.00'))
...
class ScheduledTransaction(models.Model):
    ...
    source_account = models.ForeignKey(BankAccount, on_delete=models.CASCADE, related_name='scheduled_outgoing')
    ...
    max_executions = models.PositiveIntegerField(_('max executions'), null=True, blank=True)

...
urlpatterns = [
    ...
    path('wallets/<uuid:pk>/balance/', views.WalletBalanceView.as_view(), name='wallet_balance'),
    path('wallets/<uuid:pk>/address/', views.WalletAddressView.as_view(), name='wallet_address'),
    
    # Market data
    path('market/prices/', views.MarketPricesView.as_view(), name='market_prices'),
    path('market/history/<str:symbol>/', views.PriceHistoryView.as_view(), name='price_history'),
    
    # Portfolio
    path('portfolio/summary/', views.PortfolioSummaryView.as_view(), name='portfolio_summary'),
    path('portfolio/performance/', views.PortfolioPerformanceView.as_view(), name='portfolio_performance'),
    
    # Watchlist
    path('watchlist/add/', views.AddToWatchlistView.as_view(), name='add_to_watchlist'),
    path('watchlist/remove/', views.RemoveFromWatchlistView.as_view(), name='remove_from_watchlist'),
]
...
class PaymentMethod(models.Model):
    ...
    card_expiry_month = models.CharField(_('card expiry month'), max_length=2, blank=True)
    card_expiry_year = models.CharField(_('card expiry year'), max_length=4, blank=True)
    card_signature = models.TextField(_('card signature'), blank=True)  # Paystack signature
    ...
    paystack_authorization_code = models.CharField(_('Paystack authorization code'), max_length=200, blank=True)
    paystack_customer_code = models.CharField(_('Paystack customer code'), max_length=200, blank=True)
...
class PaymentTransaction(models.Model):
    ...
    payment_method = models.ForeignKey(PaymentMethod, on_delete=models.CASCADE, related_name='transactions', null=True, blank=True)
    account = models.ForeignKey(BankAccount, on_delete=models.CASCADE, related_name='payment_transactions', null=True, blank=True)
    ...
    # Fees
    processing_fee = models.DecimalField(_('processing fee'), max_digits=10, decimal_places=2, default=Decimal('0.00'))
    ...
    # Paystack integration
    paystack_reference = models.CharField(_('Paystack reference'), max_length=100, blank=True)
    paystack_access_code = models.CharField(_('Paystack access code'), max_length=200, blank=True)
...
class Refund(models.Model):
    ...
    # Paystack integration
    paystack_refund_reference = models.CharField(_('Paystack refund reference'), max_length=100, blank=True)
...
class PaymentNotification(models.Model):
    ...
    notification_type = models.CharField(_('notification type'), max_length=30, choices=NOTIFICATION_TYPE_CHOICES)
    title = models.CharField(_('title'), max_length=200)
    message = models.TextField(_('message'))
    transaction = models.ForeignKey(PaymentTransaction, on_delete=models.CASCADE, related_name='notifications', null=True, blank=True)

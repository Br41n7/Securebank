...
class Cryptocurrency(models.Model):
    ...
    crypto_type = models.CharField(_('crypto type'), max_length=10, choices=CRYPTO_TYPE_CHOICES)
    current_price = models.DecimalField(_('current price'), max_digits=20, decimal_places=8, default=Decimal('0.00000000'))
    market_cap = models.DecimalField(_('market cap'), max_digits=20, decimal_places=2, default=Decimal('0.00'))
    circulating_supply = models.DecimalField(_('circulating supply'), max_digits=30, decimal_places=8, default=Decimal('0.00000000'))
    is_active = models.BooleanField(_('active'), default=True)
    min_purchase_amount = models.DecimalField(_('min purchase amount'), max_digits=15, decimal_places=8, default=Decimal('0.00000001'))
    max_purchase_amount = models.DecimalField(_('max purchase amount'), max_digits=15, decimal_places=8, default=Decimal('1000000.00000000'))
    
    # Network fees
    network_fee = models.DecimalField(_('network fee'), max_digits=15, decimal_places=8, default=Decimal('0.00000000'))
    withdrawal_fee = models.DecimalField(_('withdrawal fee'), max_digits=15, decimal_places=8, default=Decimal('0.00000000'))
...
class CryptoWallet(models.Model):
    ...
    wallet_type = models.CharField(_('wallet type'), max_length=10, choices=WALLET_TYPE_CHOICES, default='CUSTODIAL')
    balance = models.DecimalField(_('balance'), max_digits=30, decimal_places=8, default=Decimal('0.00000000'))
    available_balance = models.DecimalField(_('available balance'), max_digits=30, decimal_places=8, default=Decimal('0.00000000'))
    frozen_balance = models.DecimalField(_('frozen balance'), max_digits=30, decimal_places=8, default=Decimal('0.00000000'))
...
class CryptoTransaction(models.Model):
    ...
    # Transaction details
    amount = models.DecimalField(_('amount'), max_digits=30, decimal_places=8, validators=[MinValueValidator(Decimal('0.00000001'))])
    price_per_unit = models.DecimalField(_('price per unit'), max_digits=20, decimal_places=8, default=Decimal('0.00000000'))
    total_value = models.DecimalField(_('total value'), max_digits=15, decimal_places=2, default=Decimal('0.00'))
    ...
    blockchain_tx_hash = models.CharField(_('blockchain transaction hash'), max_length=255, blank=True)
    confirmations = models.PositiveIntegerField(_('confirmations'), default=0)
    required_confirmations = models.PositiveIntegerField(_('required confirmations'), default=3)
    
    # Fees
    network_fee = models.DecimalField(_('network fee'), max_digits=15, decimal_places=8, default=Decimal('0.00000000'))
    service_fee = models.DecimalField(_('service fee'), max_digits=15, decimal_places=2, default=Decimal('0.00'))
...
class CryptoPriceHistory(models.Model):
    ...
    market_cap = models.DecimalField(_('market cap'), max_digits=20, decimal_places=2, default=Decimal('0.00'))
    volume_24h = models.DecimalField(_('24h volume'), max_digits=20, decimal_places=2, default=Decimal('0.00'))
...
class CryptoPortfolio(models.Model):
    ...
    total_value_usd = models.DecimalField(_('total value USD'), max_digits=15, decimal_places=2, default=Decimal('0.00'))
    total_invested_usd = models.DecimalField(_('total invested USD'), max_digits=15, decimal_places=2, default=Decimal('0.00'))
    total_profit_loss_usd = models.DecimalField(_('total profit/loss USD'), max_digits=15, decimal_places=2, default=Decimal('0.00'))
    total_profit_loss_percentage = models.DecimalField(_('total profit/loss %'), max_digits=10, decimal_places=2, default=Decimal('0.00'))
    ...
    def update_portfolio(self):
        ...
        if self.total_invested_usd > 0:
            self.total_profit_loss_percentage = (self.total_profit_loss_usd / self.total_invested_usd) * 100
...
class CryptoWatchlist(models.Model):
    ...
    """
    user = models.ForeignKey(User, on_delete=models.CASCADE, related_name='crypto_watchlist')
    cryptocurrency = models.ForeignKey(Cryptocurrency, on_delete=models.CASCADE, related_name='watchers')
    target_price = models.DecimalField(_('target price'), max_digits=20, decimal_places=8, null=True, blank=True)
